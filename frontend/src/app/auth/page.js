    ...
    <main className="relative bg-bg01 text-tx01">
      ...
      {visible ? (
        <div className="fixed inset-0 flex items-center justify-center bg-bg01">
          <div className="bg-bg01 border-[1.5px] border-tx05 rounded-2xl flex flex-col items-center justify-between w-11/12 h-2/3 sm:w-[30rem] sm:h-2/3 relative">
            <div className="font-light tracking-[8px] uppercase text-base sm:text-xl sm:tracking-[10px] lg:text-2xl my-5 sm:my-10">
              paddel smash
            </div>

            <div className="text-center">
              <div className="text-sm font-medium tracking-[3px] uppercase  mb-2 sm:text-base">
                authenticate your account
              </div>
              <div className="text-xs font-light uppercase mb-3 sm:mb-6 sm:text-sm ">
            ...
            <div className="flex flex-col items-center mb-8 sm:mb-16">
              <div className="flex space-x-2 sm:space-x-3 mb-5 sm:mb-12">
                <input className="bg-tx01 w-8 h-10 rounded-xl sm:w-12 sm:h-16 sm:rounded-2xl" />
                <input className="bg-tx01 w-8 h-10 rounded-xl sm:w-12 sm:h-16 sm:rounded-2xl" />
                <input className="bg-tx01 w-8 h-10 rounded-xl sm:w-12 sm:h-16 sm:rounded-2xl" />
                <input className="bg-tx01 w-8 h-10 rounded-xl sm:w-12 sm:h-16 sm:rounded-2xl" />
                <input className="bg-tx01 w-8 h-10 rounded-xl sm:w-12 sm:h-16 sm:rounded-2xl" />
              ...
              <div>
                <Link className="mb-3" href={"/auth"}>
                  <div className="text-2xl font-extralight tracking-[6px] sm:text-3xl">
                    virify
                  </div>
                </Link>
              </div>
