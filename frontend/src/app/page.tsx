...
function FeaturesSection({ hover, ...props }: any) {
  return (
    <section
...
function TechnologySection({ hover, ...props }: any) {
  return (
    <section
...
function FooterSection({ hover, ...props }: any) {
  return (
...
const PressButton = forwardRef(function PressButton(props: any, ref: any) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative"
      >
        <Image alt="" src={logoPic} className="h-52 w-52 lg:h-72 lg:w-72" />
        <button
  ...
  return (
    ...
    >
      <div className="no-scrollbar relative flex h-3/5 max-h-[45rem] w-11/12 flex-col items-center justify-between overflow-auto rounded-2xl border-[1.5px] border-tx05 bg-bg01 sm:h-2/3 sm:w-[30rem]">
        ...
        <Image alt="" src={logoPic} className="h-52 w-52 sm:h-64 sm:w-64" />
